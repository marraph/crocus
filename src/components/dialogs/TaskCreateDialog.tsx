...
export const TaskCreateDialog = React.forwardRef<HTMLDialogElement, React.DialogHTMLAttributes<HTMLDialogElement>>(({className, ...props}, ref) => {
    ...
    return (
        <>
            ...
            <Dialog
                className={cn("border border-white border-opacity-20 top-1/3 left-1/3 w-4/12 drop-shadow-2xl ", className)}  {...props} ref={ref}
                ...
                <DialogContent className={cn("flex flex-row justify-between space-x-4 px-4 pt-4 pb-2", className)}>
                    <div className={cn("flex flex-col flex-grow space-y-2", className)}>
                        ...
                        <Textarea placeholder={"Add Description..."}
                                  className={cn("h-20 bg-black placeholder-placeholder", className)}></Textarea>
                    ...
                    <CloseButton className={cn("h-min w-min", className)} text={""}
                                 onClick={() => setIsOpen(false)}></CloseButton>
                </DialogContent>
