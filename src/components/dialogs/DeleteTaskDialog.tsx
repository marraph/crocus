...
interface DeleteTaskDialogProps extends React.DialogHTMLAttributes<HTMLDialogElement> {
    buttonTrigger: boolean;
}

export const DeleteTaskDialog = React.forwardRef<HTMLDialogElement, DeleteTaskDialogProps>(({ buttonTrigger, className, ...props}) => {
